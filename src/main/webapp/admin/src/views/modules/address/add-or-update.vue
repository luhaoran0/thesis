	...
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="Consignee" prop="name">
					<el-input v-model="ruleForm.name" placeholder="Consignee" clearable  :readonly="ro.name"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="Consignee" prop="name">
					<el-input v-model="ruleForm.name" placeholder="Consignee" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="Telephone" prop="phone">
					<el-input v-model="ruleForm.phone" placeholder="Telephone" clearable  :readonly="ro.phone"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="Telephone" prop="phone">
					<el-input v-model="ruleForm.phone" placeholder="Telephone" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="Default Address [Yes/No]" prop="isdefault">
					<el-input v-model="ruleForm.isdefault" placeholder="Default Address [Yes/No]" clearable  :readonly="ro.isdefault"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="Default Address [Yes/No]" prop="isdefault">
					<el-input v-model="ruleForm.isdefault" placeholder="Default Address [Yes/No]" readonly></el-input>
				</el-form-item>
			</template>
	...
	data() {
		...
		return {
			...
			rules: {
				...
				isdefault: [
					{ required: true, message: 'Default address [Yes/No] cannot be empty', trigger: 'blur' },
				],
			}
		};
	},
