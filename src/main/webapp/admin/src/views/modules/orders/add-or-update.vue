	...
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template v-show="logistics">
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'" label="Order Number" prop="orderid">
					<el-input v-model="ruleForm.orderid" placeholder="Order Number" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.orderid" label="Order Number" prop="orderid">
					<el-input v-model="ruleForm.orderid" placeholder="Order Number" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="upload" v-if="type!='info' && !ro.picture" label="Product Picture" prop="picture">
					<file-upload
						tip="点击上传Product Picture"
						action="file/upload"
						:limit="3"
						:multiple="true"
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="upload" v-else-if="ruleForm.picture" label="Product Picture" prop="picture">
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="Discount Price" prop="discountprice">
					<el-input v-model="ruleForm.discountprice" placeholder="Discount Price" clearable  :readonly="ro.discountprice"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="Discount Price" prop="discountprice">
					<el-input v-model="ruleForm.discountprice" placeholder="Discount Price" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="Total Price" prop="total">
					<el-input v-model="ruleForm.total" placeholder="Total Price" clearable  :readonly="ro.total"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="Total Price" prop="total">
					<el-input v-model="ruleForm.total" placeholder="Total Price" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="Discount Price" prop="discounttotal">
					<el-input v-model="ruleForm.discounttotal" placeholder="Discount Price" clearable  :readonly="ro.discounttotal"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="Discount Price" prop="discounttotal">
					<el-input v-model="ruleForm.discounttotal" placeholder="Discount Price" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="select" v-if="type!='info'"  label="Payment Type" prop="type">
					<el-select :disabled="ro.type" v-model="ruleForm.type" placeholder="Please select a payment type" >
						<el-option
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="Payment Type" prop="type">
					<el-input v-model="ruleForm.type-0==1?'cash':'integral'"
						placeholder="Payment Type" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="select" v-if="type!='info'"  label="Status" prop="status">
					<el-select :disabled="ro.status" v-model="ruleForm.status" placeholder="Please select a status" >
						<el-option
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="Status" prop="status">
					<el-input v-model="ruleForm.status"
						placeholder="Status" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="Address" prop="address">
					<el-input v-model="ruleForm.address" placeholder="Address" clearable  :readonly="ro.address"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="Address" prop="address">
					<el-input v-model="ruleForm.address" placeholder="Address" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="Telephone" prop="tel">
					<el-input v-model="ruleForm.tel" placeholder="Telephone" clearable  :readonly="ro.tel"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="Telephone" prop="tel">
					<el-input v-model="ruleForm.tel" placeholder="Telephone" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="Consignee" prop="consignee">
					<el-input v-model="ruleForm.consignee" placeholder="Consignee" clearable  :readonly="ro.consignee"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="Consignee" prop="consignee">
					<el-input v-model="ruleForm.consignee" placeholder="Consignee" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="Remarks" prop="remark">
					<el-input v-model="ruleForm.remark" placeholder="Remarks" clearable  :readonly="ro.remark"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="Remarks" prop="remark">
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-if="type=='info'" class="input" label="Order time" prop="addtime">
					<el-input v-model="ruleForm.addtime" placeholder="Order time" readonly></el-input>
				</el-form-item>
			</template>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-if="type!='info'"  label="logistics" prop="logistics">
					<editor 
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else-if="ruleForm.logistics" label="logistics" prop="logistics">
...
export default {
	...
	methods: {
		...
		init(id,type) {
            ...
            this.typeOptions = "Cash,Points".split(',')
	...
	this.ruleForm.logistics = this.ruleForm.logistics.replace(reg,'../../../ssm591p5/upload');
        } else {
