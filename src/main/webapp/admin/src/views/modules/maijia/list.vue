      ...
      >
        <el-row :style="{ textAlign: 'right', display: 'block' }">
          ...
          <div :style="{ margin: '0 20px 0 0', display: 'inline-block' }">
            ...
            >
            <el-input
              v-model="searchForm.maijiaxingming"
        ...
        >
          <template slot-scope="scope">
            <div v-if="scope.row.zhaopian">
              <img
                :src="$base.url + scope.row.zhaopian.split(',')[0]"
                width="100"
                height="100"
              />
            </div>
  ...
  methods: {
    ...
    getDataList() {
      ...
      if (
        ...
        this.searchForm.maijiaxingming != undefined
      ) {
