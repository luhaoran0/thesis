<template>
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="Student ID" prop="xuehao">
					<el-input v-model="ruleForm.xuehao" placeholder="Student ID" clearable  :readonly="ro.xuehao"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="Student ID" prop="xuehao">
					<el-input v-model="ruleForm.xuehao" placeholder="Student ID" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="password" prop="mima">
					<el-input v-model="ruleForm.mima" placeholder="password" clearable  :readonly="ro.mima"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="password" prop="mima">
					<el-input v-model="ruleForm.mima" placeholder="password" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="Name" prop="xingming">
					<el-input v-model="ruleForm.xingming" placeholder="Name" clearable  :readonly="ro.xingming"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="Name" prop="xingming">
					<el-input v-model="ruleForm.xingming" placeholder="Name" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="select" v-if="type!='info'"  label="Gender" prop="xingbie">
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="Gender" prop="xingbie">
					<el-input v-model="ruleForm.xingbie"
						placeholder="Gender" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="upload" v-if="type!='info' && !ro.touxiang" label="head portrait" prop="touxiang">
					<file-upload
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="upload" v-else-if="ruleForm.touxiang" label="head portrait" prop="touxiang">
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="mobile phone" prop="shouji">
					<el-input v-model="ruleForm.shouji" placeholder="mobile phone" clearable  :readonly="ro.shouji"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="mobile phone" prop="shouji">
					<el-input v-model="ruleForm.shouji" placeholder="mobile phone" readonly></el-input>
				</el-form-item>
			</template>
