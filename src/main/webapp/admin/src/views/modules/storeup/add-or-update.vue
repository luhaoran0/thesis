<template>
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="Favorite Name" prop="name">
					<el-input v-model="ruleForm.name" placeholder="Favorite Name" clearable  :readonly="ro.name"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="Favorite Name" prop="name">
					<el-input v-model="ruleForm.name" placeholder="Favorite Name" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="upload" v-if="type!='info' && !ro.picture" label="Favorite Pictures" prop="picture">
					<file-upload
						tip="Click to upload Favorite Pictures"
						action="file/upload"
						:limit="3"
						:multiple="true"
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="upload" v-else-if="ruleForm.picture" label="Favorite Pictures" prop="picture">
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="Recommended type" prop="inteltype">
					<el-input v-model="ruleForm.inteltype" placeholder="Recommended type" clearable  :readonly="ro.inteltype"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="Recommended type" prop="inteltype">
					<el-input v-model="ruleForm.inteltype" placeholder="Recommended type" readonly></el-input>
				</el-form-item>
			</template>
	...
	data() {
		...
		return {
			...
			rules: {
				...
				name: [
					{ required: true, message: 'Favorite Name cannot be empty', trigger: 'blur' },
				],
				picture: [
					{ required: true, message: 'Favorite pictures cannot be empty', trigger: 'blur' },
				],
				type: [
				],
				inteltype: [
