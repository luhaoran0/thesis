      ...
      >
        <el-row :style="{ textAlign: 'right', display: 'block' }">
          <div :style="{ margin: '0 20px 0 0', display: 'inline-block' }">
            <label
              ...
              class="item-label"
              >Book classification</label
            >
            <el-input
              v-model="searchForm.tushufenlei"
        ...
        <el-row :style="{ margin: '20px 0', display: 'flex' }">
          ...
          <el-button
            ...
            v-if="isAuth('tushufenlei', 'Remove')"
        ...
        <el-table-column width="300" label=" operation">
          <template slot-scope="scope">
            ...
            <el-button
              ...
              v-if="isAuth('tushufenlei', 'Update')"
              type="primary"
              size="mini"
  ...
  methods: {
    ...
    getDataList() {
      ...
      if (
        ...
        this.searchForm.tushufenlei != undefined
      ) {
