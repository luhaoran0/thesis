<template>
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="Book classification" prop="tushufenlei">
					<el-input v-model="ruleForm.tushufenlei" placeholder="Book classification" clearable  :readonly="ro.tushufenlei"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="Book classification" prop="tushufenlei">
					<el-input v-model="ruleForm.tushufenlei" placeholder="Book classification" readonly></el-input>
				</el-form-item>
			</template>
