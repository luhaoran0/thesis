      ...
      >
        ...
        <el-row :style="{ margin: '20px 0', display: 'flex' }">
          <el-button
            ...
            v-if="isAuth('discusstushuxinxi', 'Add')"
            type="success"
          ...
          <el-button
            ...
            v-if="isAuth('discusstushuxinxi', 'Remove')"
        ...
        <el-table-column width="300" label=" operation">
          <template slot-scope="scope">
            <el-button
              ...
              v-if="isAuth('discusstushuxinxi', 'Update')"
              type="primary"
              size="mini"
            ...
            <el-button
              ...
              v-if="isAuth('discusstushuxinxi', 'View Comments')"
              type="primary"
              size="mini"
