	...
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="textarea" v-if="type!='info'" label="Comments" prop="content">
					<el-input
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else-if="ruleForm.content" label="Comments" prop="content">
					<span :style='{"fontSize":"14px","lineHeight":"40px","color":"#333","fontWeight":"500","display":"inline-block"}'>{{ruleForm.content}}</span>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="textarea" v-if="type!='info'" label="Reply content" prop="reply">
					<el-input
					  style="min-width: 200px; max-width: 600px;"
					  type="textarea"
					  :rows="8"
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else-if="ruleForm.reply" label="Reply content" prop="reply">
...
export default {
	data() {
		...
		return {
			...
			rules: {
				refid: [
					{ required: true, message: 'The associated table ID cannot be empty', trigger: 'blur' },
				],
				userid: [
				...
				content: [
					{ required: true, message: 'Comments cannot be empty', trigger: 'blur' },
				],
				reply: [
				],
			}
