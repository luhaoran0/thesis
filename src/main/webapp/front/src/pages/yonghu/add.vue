...
<div :style='{"width":"1200px","padding":"20px","boxShadow":"0px 4px 10px 0px rgba(0,0,0,0.302)","margin":"10px auto","position":"relative","background":"#fff"}'>
    ...
    >
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px"}' label="Name" prop="xingming">
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px"}' label="head portrait" prop="touxiang">
            <file-upload
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px"}' label="mobile phone" prop="shouji">
            <el-input v-model="ruleForm.shouji" 
                placeholder="mobile phone" clearable ></el-input>
          </el-form-item>
