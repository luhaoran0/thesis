<template>
  <div class="main-containers">
    <div
      class="top-container"
      :style="{
        boxShadow: '0 1px 6px rgba(64, 158, 255, .3)',
        padding: '0 20px',
        alignItems: 'center',
        display: 'flex',
    ...
    >
      ...
      <div
        v-if="true"
        :style="{ color: 'rgba(255, 255, 255, 1)', fontSize: '24px' }"
      >
      ...
      <div>
        <div
          v-if="false"
          :style="{ color: '#666', fontSize: '14px', display: 'inline-block' }"
        >
          0753-1234567
        </div>
        <el-button
        ...
        >
          ...
          <el-menu-item @click="goBackend">
            ...
            <span
              ...
              >backstage manage</span
            >
          </el-menu-item>
          <el-menu-item
            :index="menuList.length + 1 + ''"
            @click="goMenu('/index/cart')"
          >
            <i
              v-if="true"
              :style="{
    ...
    >
      ...
      >
        <div
          :class="{
            'right-content': item.reply == '' || item.reply == null,
            'left-content': item.ask == '' || item.ask == null,
          }"
          v-for="item in chatList"
          :key="item.id"
        >
          <el-tag
            :type="item.ask == '' || item.ask == null ? 'warning' : 'success'"
            style="margin: 10px"
          >
      ...
      <div slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="addChat">send out</el-button>
      </div>
    </el-dialog>
  </div>
</template>
