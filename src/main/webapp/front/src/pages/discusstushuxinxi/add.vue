...
<div :style='{"width":"1200px","padding":"20px","boxShadow":"0px 4px 10px 0px rgba(0,0,0,0.302)","margin":"10px auto","position":"relative","background":"#fff"}'>
    <el-form
      ...
      label-width="120px"
    >
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px"}' label="User Name" prop="nickname">
            <el-input v-model="ruleForm.nickname" 
                placeholder="User Name" clearable ></el-input>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px"}' label="Comments" prop="content">
            <el-input
              type="textarea"
              :rows="8"
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px"}' label="Reply content" prop="reply">
            <el-input
              type="textarea"
              :rows="8"
