...
import OrderXzConfirm from '../pages/shop-order/xzconfirm'
import Cart from '../pages/shop-cart/list'
import News from '../pages/news/news-list'
import NewsDetail from '../pages/news/news-detail'
import maijiaList from '../pages/maijia/list'
import maijiaDetail from '../pages/maijia/detail'
import maijiaAdd from '../pages/maijia/add'
...
import liaotianjiluList from '../pages/liaotianjilu/list'
import liaotianjiluDetail from '../pages/liaotianjilu/detail'
import liaotianjiluAdd from '../pages/liaotianjilu/add'
      ...
      redirect: '/index/home'
    },
		{
			...
			children:[
				...
				{
					path: 'shop-order/orderXzConfirm',
					component: OrderXzConfirm
				},
				{
					path: 'news',
					component: News
				...
				{
					path: 'liaotianjilu',
					component: liaotianjiluList
				},
				{
					path: 'liaotianjiluDetail',
					component: liaotianjiluDetail
				},
				{
					path: 'liaotianjiluAdd',
					component: liaotianjiluAdd
				},
			]
		},
		{
